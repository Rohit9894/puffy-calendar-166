        ...
        <VStack w={"100%"}  textAlign="center" display={"block"} justifyContent={"center"} marginTop={10}>
          ...
          <SimpleGrid columns={['1','2']} direction={['column', 'row']}  spacing={20} gap={50} >
            ...
            <VStack w={"100%"}  textAlign="center" display={"block"} justifyContent={"center"} marginTop={10}>
              ...
              <VStack gap={4} >
                <Box display={"block"} lineHeight={1.2} fontWeight={500} textAlign={"left"} fontSize="1.125rem" color="#202c45" fontFamily={"Poppins,-apple-system,BlinkMacSystemFont,Segoe UI,Roboto,Helvetica Neue,Arial,sans-serif,Apple Color Emoji,Segoe UI Emoji,Segoe UI Symbol,Noto Color Emoji"}  >
    ...
    <Box h="130%" m="100px auto" w="80%" border={"1px solid red"}>
        ...
        <VStack w={"100%"}  textAlign="center" display={"block"} justifyContent={"center"} marginTop={10}>
          ...
          <SimpleGrid columns={['1','2']} direction={['column', 'row']}    w="100%" h="100%"  >
              ...
              <Box >
                <Image m={0} p={0} src='https://mailtrap.io/wp-content/uploads/2022/02/sending-landing-alerts.svg' />
              </Box>

    
            <Box >
              <Image m={0} p={0} src='https://mailtrap.io/wp-content/uploads/2022/02/sending-landing-api-smtp.svg' />
            </Box>

            <Box marginTop={{base:10, lg:28}}>
              <VStack>
                <Heading fontSize={"26px"} fontWeight={700} textAlign="left" color="#202c45" lineHeight={1.3} fontFamily="Poppins,-apple-system,BlinkMacSystemFont,Segoe UI,Roboto,Helvetica Neue,Arial,sans-serif,Apple Color Emoji,Segoe UI Emoji,Segoe UI Symbol,Noto Color Emoji" >SMTP and APIs Compatible with Sendgrid, Mailgun, Mandrill</Heading>
                <Text fontWeight={400} fontSize="14px" textAlign="left" lineHeight={1.7} color="#202c45" fontFamily={"Inter,-apple-system,BlinkMacSystemFont,Segoe UI,Roboto,Helvetica Neue,Arial,sans-serif,Apple Color Emoji,Segoe UI Emoji,Segoe UI Symbol,Noto Color Emoji"} >We support standard SMTP protocol and have compatible APIs. This saves time and makes the switch to Mailtrap easier.</Text>
            ...
            <Box marginTop={{base:10, lg:28}}>
              <VStack>
                <Heading fontSize={"26px"} fontWeight={700} textAlign="left" color="#202c45" lineHeight={1.3} fontFamily="Poppins,-apple-system,BlinkMacSystemFont,Segoe UI,Roboto,Helvetica Neue,Arial,sans-serif,Apple Color Emoji,Segoe UI Emoji,Segoe UI Symbol,Noto Color Emoji" >60 Days of Detailed Logs</Heading>
                <Text fontWeight={400} fontSize="14px" textAlign="left" lineHeight={1.7} color="#202c45" fontFamily={"Inter,-apple-system,BlinkMacSystemFont,Segoe UI,Roboto,Helvetica Neue,Arial,sans-serif,Apple Color Emoji,Segoe UI Emoji,Segoe UI Symbol,Noto Color Emoji"} >Within 60 days you get access to all messages history. You can find the needed email, inspect it, troubleshoot and debug.</Text>
            ...
            <Box >
              <Image m={0} p={0} src='https://mailtrap.io/wp-content/uploads/2022/02/sending-landing-email-logs.svg' />
            </Box>

            <Box >
              <Image m={0} p={0} src='https://mailtrap.io/wp-content/uploads/2022/02/sending-landing-setup.svg' />
            </Box>

            <Box marginTop={{base:15, lg:28}}>
              <VStack>
                <Heading fontSize={"26px"} fontWeight={700} textAlign="left" color="#202c45" lineHeight={1.3} fontFamily="Poppins,-apple-system,BlinkMacSystemFont,Segoe UI,Roboto,Helvetica Neue,Arial,sans-serif,Apple Color Emoji,Segoe UI Emoji,Segoe UI Symbol,Noto Color Emoji" >Secure and User-Friendly Setup</Heading>
                <Text fontWeight={400} fontSize="14px" textAlign="left" lineHeight={1.7} color="#202c45" fontFamily={"Inter,-apple-system,BlinkMacSystemFont,Segoe UI,Roboto,Helvetica Neue,Arial,sans-serif,Apple Color Emoji,Segoe UI Emoji,Segoe UI Symbol,Noto Color Emoji"} >We help you get all the necessary DNS records to ensure great deliverability. We also rotate your DKIM keys to provide another layer of security. Follow the step-by-step wizard to complete the setup in a few minutes.</Text>
            ...
            <Box marginTop={{base:10, lg:28}}>
              <VStack>
                <Heading fontSize={"26px"} fontWeight={700} textAlign="left" color="#202c45" lineHeight={1.3} fontFamily="Poppins,-apple-system,BlinkMacSystemFont,Segoe UI,Roboto,Helvetica Neue,Arial,sans-serif,Apple Color Emoji,Segoe UI Emoji,Segoe UI Symbol,Noto Color Emoji" >Single Screen Email Stats</Heading>
                <Text fontWeight={400} fontSize="14px" textAlign="left" lineHeight={1.7} color="#202c45" fontFamily={"Inter,-apple-system,BlinkMacSystemFont,Segoe UI,Roboto,Helvetica Neue,Arial,sans-serif,Apple Color Emoji,Segoe UI Emoji,Segoe UI Symbol,Noto Color Emoji"} >A quick look at the dashboard gives your team insight into the critical metrics. When necessary, dig deeper to improve your email perfomance.</Text>
            ...
            <Box >
              <Image m={0} p={0} src='https://mailtrap.io/wp-content/uploads/2022/02/sending-landing-single-screen-analytics.svg' />
            </Box>

            <Box >
              <Image m={0} p={0} src='https://mailtrap.io/wp-content/uploads/2022/02/sending-landing-all-in-one.svg' />
            </Box>

            <Box marginTop={{base:10, lg:28}}>
              <VStack>
                <Heading fontSize={"26px"} fontWeight={700} textAlign="left" color="#202c45" lineHeight={1.3} fontFamily="Poppins,-apple-system,BlinkMacSystemFont,Segoe UI,Roboto,Helvetica Neue,Arial,sans-serif,Apple Color Emoji,Segoe UI Emoji,Segoe UI Symbol,Noto Color Emoji" >Test, Send, Monitor Emails in One Place </Heading>
                <Text fontWeight={400} fontSize="14px" textAlign="left" lineHeight={1.7} color="#202c45" fontFamily={"Inter,-apple-system,BlinkMacSystemFont,Segoe UI,Roboto,Helvetica Neue,Arial,sans-serif,Apple Color Emoji,Segoe UI Emoji,Segoe UI Symbol,Noto Color Emoji"} >No need to log into a few systems and to manage billing for all of them. Complete email development cycle – test and send your emails within one solution.</Text>
              </VStack>
      ...
      {/* <HStack w="100%" justify={"space-evenly"}> */}
        <VStack w={"100%"}  textAlign="center" display={"block"} justifyContent={"center"} marginTop={10}>
          ...
          <SimpleGrid columns={[1, null, 2]} spacing={10}  >
            ...
            <Box h="100%" w="100%" spacing={10} marginTop={5} borderRadius={"0.625rem"} bgColor="#fff" display={"block"} lineHeight={1.7} boxShadow={"0 0.3125rem 1rem rgb(0 0 0 / 7%)"} textAlign="left" color="#202c45" fontWeight={400} fontFamily="Inter,-apple-system,BlinkMacSystemFont,Segoe UI,Roboto,Helvetica Neue,Arial,sans-serif,Apple Color Emoji,Segoe UI Emoji,Segoe UI Symbol,Noto Color Emoji">
              <VStack marginTop={5}>
                <Text marginLeft={5} marginRight={5} display={"block"} fontSize="14px" lineHeight={1.7} fontWeight={400} color="#202c45" textAlign={"left"} fontFamily="Inter,-apple-system,BlinkMacSystemFont,Segoe UI,Roboto,Helvetica Neue,Arial,sans-serif,Apple Color Emoji,Segoe UI Emoji,Segoe UI Symbol,Noto Color Emoji" >
              ...
              <VStack rows={[1, null, 1]} spacing={1} display="block" textAlign="left" marginLeft={5}  marginTop={5}>
                <Text fontSize={"1.125rem"} textAlign="left" color="#202c45" display={"block"} fontWeight={600} lineHeight={1.7} fontFamily={"Poppins,-apple-system,BlinkMacSystemFont,Segoe UI,Roboto,Helvetica Neue,Arial,sans-serif,Apple Color Emoji,Segoe UI Emoji,Segoe UI Symbol,Noto Color Emoji"}>Will Henderson </Text>
                <Text lineHeight={1.7} color={"#202c45"} display={"block"} fontSize=".75rem" fontWeight={600} textAlign="left" fontFamily={"Inter,-apple-system,BlinkMacSystemFont,Segoe UI,Roboto,Helvetica Neue,Arial,sans-serif,Apple Color Emoji,Segoe UI Emoji,Segoe UI Symbol,Noto Color Emoji"}>CPO @ Knowa.co</Text>
              </VStack>
        ...
        <VStack w={"100%"}  textAlign="center" display={"block"} justifyContent={"center"} marginTop={10}>
          ...
          <SimpleGrid columns={[1, null, 2]} spacing={10}  >
            ...
            <Box h="100%" spacing={10} borderRadius={"0.625rem"} bgColor="#fff" display={"block"} lineHeight={1.7} boxShadow={"0 0.3125rem 1rem rgb(0 0 0 / 7%)"} textAlign="left" color="#202c45" fontWeight={400} fontFamily="Inter,-apple-system,BlinkMacSystemFont,Segoe UI,Roboto,Helvetica Neue,Arial,sans-serif,Apple Color Emoji,Segoe UI Emoji,Segoe UI Symbol,Noto Color Emoji">
              <HStack columns={[1, null, 2]} spacing={2} marginLeft={5} marginTop={5} marginBottom={1}>
            ...
            <Box h="100%" spacing={10} borderRadius={"0.625rem"} bgColor="#fff" display={"block"} lineHeight={1.7} boxShadow={"0 0.3125rem 1rem rgb(0 0 0 / 7%)"} textAlign="left" color="#202c45" fontWeight={400} fontFamily="Inter,-apple-system,BlinkMacSystemFont,Segoe UI,Roboto,Helvetica Neue,Arial,sans-serif,Apple Color Emoji,Segoe UI Emoji,Segoe UI Symbol,Noto Color Emoji">
              ...
              <VStack>
                <Text marginLeft={5} marginBottom={10} marginRight={4} display={"block"} fontSize="14px" lineHeight={1.7} fontWeight={400} color="#202c45" textAlign={"left"} fontFamily="Inter,-apple-system,BlinkMacSystemFont,Segoe UI,Roboto,Helvetica Neue,Arial,sans-serif,Apple Color Emoji,Segoe UI Emoji,Segoe UI Symbol,Noto Color Emoji" >
                First 6 months are free if you send less than 100,000 emails/m. Further Mailtrap pricing plans are described here. BTW, you don’t need to provide credit card information to get started with our Sending solution.  
                </Text>
              </VStack>
            ...
            <Box h="100%" spacing={10} borderRadius={"0.625rem"} bgColor="#fff" display={"block"} lineHeight={1.7} boxShadow={"0 0.3125rem 1rem rgb(0 0 0 / 7%)"} textAlign="left" color="#202c45" fontWeight={400} fontFamily="Inter,-apple-system,BlinkMacSystemFont,Segoe UI,Roboto,Helvetica Neue,Arial,sans-serif,Apple Color Emoji,Segoe UI Emoji,Segoe UI Symbol,Noto Color Emoji">
              ...
              <VStack>
                <Text marginLeft={5} marginBottom={10} marginRight={5} display={"block"} fontSize="14px" lineHeight={1.7} fontWeight={400} color="#202c45" textAlign={"left"} fontFamily="Inter,-apple-system,BlinkMacSystemFont,Segoe UI,Roboto,Helvetica Neue,Arial,sans-serif,Apple Color Emoji,Segoe UI Emoji,Segoe UI Symbol,Noto Color Emoji" >
                Yes, more than 900,000 developers have trusted Mailtrap for 9 years. Companies those switched to Mailtrap SMTP even report some increases in deliverability rates. And we wouldn’t offer something to our customers that we don’t use ourselves. 
                </Text>
              </VStack>
