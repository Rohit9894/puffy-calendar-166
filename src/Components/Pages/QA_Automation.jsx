    ...
    <>
        ...
        <VStack w={"100%"}  textAlign="center" display={"block"} justifyContent={"center"} marginTop={10}>
          ...
          <SimpleGrid columns={['1','2']} direction={['column', 'row']}  spacing={20} gap={50} >
            ...
            <VStack w={"82%"} textAlign="center" display={"block"} justifyContent={"center"} marginTop={10}>
              ...
              <Box>
              <Flex w="120%" direction={{base:"column",lg:"row"}}  display={"flex"} alignItems="center" textAlign="center" justifyContent={"center"} marginTop={5}>
            ...
            <Box>
              <HStack>
                ...
                <VStack>
                  ...
                  <Box display={"block"} fontSize={"13px"} lineHeight={1.7} fontWeight={400} color={"#202c45"} textAlign="left" fontFamily={"Inter,-apple-system,BlinkMacSystemFont,Segoe UI,Roboto,Helvetica Neue,Arial,sans-serif,Apple Color Emoji,Segoe UI Emoji,Segoe UI Symbol,Noto Color Emoji"}>Sandbox Fake SMTP works seamlessly with Selenium, Cucumber, Protractor, and many other testing tools.</Box>
                </VStack>
