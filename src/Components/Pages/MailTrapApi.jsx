          ...
          >
            ...
            <Box>
              <Image
                h="80%"
                w="100%"
                src="https://mailtrap.io/wp-content/uploads/2021/05/img__API.svg"
              />
            </Box>
          </SimpleGrid>
        </VStack>
            ...
            <Box>
              <HStack>
                ...
                <VStack>
                  ...
                  >
                    Complex workflows call for comprehensive solutions. Test any
                    number of unique emails in a matter of seconds.
                  </Box>
                </VStack>
              </HStack>
            </Box>
            ...
            <Box>
              <HStack>
                <Image
                  ...
                  h={82}
                  marginBottom={5}
                  src="https://mailtrap.io/wp-content/uploads/2021/01/search-icon.svg"
                />
                <VStack>
                  <Box
                  ...
                  >
                    Raw headers are visible for each email you send. Validate
                    each and easily catch any inconsistencies.
                  </Box>
                </VStack>
              </HStack>
            </Box>
            ...
            <Box>
              <HStack>
                <Image
                  ...
                  h={82}
                  marginBottom={5}
                  src="https://mailtrap.io/wp-content/uploads/2021/01/quickly-logo-1.svg"
                />
                <VStack>
                  <Box
                    fontSize={"1.125rem"}
                  ...
                  >
                    Our API works seamlessly with any WebCI and features an
                    extensive documentation. There’s hardly any learning curve.
                  </Box>
                </VStack>
              </HStack>
            </Box>
            ...
            <Box>
              <HStack>
                <Image
                  ...
                  h={82}
                  marginBottom={5}
                  src="https://mailtrap.io/wp-content/uploads/2021/01/schedule-icon.svg"
                />
                <VStack>
                  <Box
                    fontSize={"1.125rem"}
                  ...
                  >
                    Save time by letting API handle the dull checks of your
                    emails. Be the first to know if any issues occur.
                  </Box>
                </VStack>
              </HStack>
            </Box>
            ...
            <Box>
              <HStack>
                <Image
                  ...
                  h={82}
                  marginBottom={5}
                  src="https://mailtrap.io/wp-content/uploads/2021/01/email-icon.svg"
                />
                <VStack>
                  <Box
                    fontSize={"1.125rem"}
                  ...
                  >
                    With features such as bcc tracking or individual email per
                    inbox, you can monitor live emails with ease.
                  </Box>
                </VStack>
              </HStack>
            </Box>
            ...
            <Box>
              <HStack>
                <Image
                  ...
                  h={82}
                  marginBottom={5}
                  src="https://mailtrap.io/wp-content/uploads/2021/01/email-icon-1.svg"
                />
                <VStack>
                  <Box
                    fontSize={"1.125rem"}
                  ...
                  >
                    Verifying if emails are sent is just the first step. Check
                    their spam score, validate the headers, HTML, and a lot
                    more.
                  </Box>
                </VStack>
              </HStack>
          ...
          <SimpleGrid columns={[1, null, 3]} spacing="40px" w="100%" gap={10}>
            ...
            <Box w="90%" textAlign="center">
              <Image
                ...
                display={"block"}
                textAlign="center"
                src="https://mailtrap.io/wp-content/uploads/2021/05/img__fake-email-environment.svg"
              />
              <Heading
                textAlign={"center"}
                mb={"1rem"}
              ...
              >
                Test email sending from your project and view each email sent in
                your Sandbox inbox. Never send a thing to recipients’ inboxes.
              </Text>
